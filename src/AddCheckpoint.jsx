      ...
      <div className="rounded-3xl border border-white/10 bg-slate-950/70 p-6">
        ...
        <div className="mt-6 space-y-4">
          ...
          <button
            ...
            onClick={handleAdd}
            disabled={loading}
            className="w-full rounded-2xl bg-amber-300 px-4 py-3 font-medium text-slate-950 transition hover:bg-amber-200 disabled:cursor-not-allowed disabled:bg-slate-600 disabled:text-slate-300"
          >
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          {quickLocations.map((item) => (
            <button
              ...
              className="rounded-full border border-white/10 bg-white/[0.03] px-4 py-2 text-sm text-slate-200 transition hover:border-cyan-400/40"
            >
              {item}
            </button>
          ))}
